...
This is a modified file for use with the NGFC flowsheet example. The equation
for enth_mol_ig_comp has been changed for use with Gibbs reactors.
"""
...
class entr_mol_ig_comp():
    ...
    def return_expression(b, cobj, T):
        ...
        t = pyunits.convert(T, to_units=pyunits.kiloK)
        s = (cobj.cp_mol_ig_comp_coeff_A*log(t/pyunits.kiloK) +
             cobj.cp_mol_ig_comp_coeff_B*t +
