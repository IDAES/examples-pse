...
"""
    Branin function, see Fang paper
        - 49 uniform samples and used to train RBF
...
def main():
    ...
    tr_data = sp.UniformSampling(test_data, [9, 9])
    ...
    ypred = f2.kriging_predict_output(results_pyomo, test_data.values[:, :-1])
    r2_pred = f2.r2_calculation(test_data.values[:, -1], ypred_2)
