...
::
    ...
    ~/miniconda3/envs/sphinx_gallery/lib/python3.8/site-packages/idaes/dmf/workspace.py in __init__(self, path, create, add_defaults, html_paths)
        204             try:
    --> 205                 assert os.path.isfile(self._conf)
    ...
    WorkspaceConfNotFoundError                Traceback (most recent call last)
    ...
    ~/src/idaes/examples-dev/src/properties/Workshop_Module_2_DMF/hda_ideal_VLE.py in <module>
         60 
    ...
    ~/miniconda3/envs/sphinx_gallery/lib/python3.8/site-packages/idaes/dmf/workspace.py in __init__(self, path, create, add_defaults, html_paths)
        205                 assert os.path.isfile(self._conf)
        206             except AssertionError:
    --> 207                 raise WorkspaceConfNotFoundError(self._conf)
        208         self._install_dir = self._get_install_dir()
        209         try:


    WorkspaceConfNotFoundError: Workspace config not found at path "/home/dang/src/idaes/examples-dev/src/properties/Workshop_Module_2_DMF/config.yaml" 
