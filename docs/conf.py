...
version = idaes_version
# The full version, including alpha/beta/rc tags.
release = idaes_version
...
latex_documents = [
    (master_doc, 'IDAES-examples.tex', u'IDAES Examples Documentation', u'IDAES team', 'manual')
]
