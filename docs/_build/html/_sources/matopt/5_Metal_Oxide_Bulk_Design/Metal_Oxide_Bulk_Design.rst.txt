...
.. parsed-literal::
    ...
    Logfile '/tmp/tmpy9ceqptx.cplex.log' open.
    ...
    CPLEX> Problem '/tmp/tmpkqhwk1hp.pyomo.lp' read.
    Read time = 0.05 sec. (0.31 ticks)
    CPLEX> Problem name         : /tmp/tmpkqhwk1hp.pyomo.lp
