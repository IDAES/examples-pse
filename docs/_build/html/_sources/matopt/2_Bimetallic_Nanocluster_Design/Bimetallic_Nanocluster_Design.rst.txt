...
.. parsed-literal::
    ...
    Logfile '/tmp/tmp6mhhfxt8.cplex.log' open.
    ...
    CPLEX> Problem '/tmp/tmpfy9klp2r.pyomo.lp' read.
    Read time = 0.00 sec. (0.06 ticks)
    CPLEX> Problem name         : /tmp/tmpfy9klp2r.pyomo.lp
    ...
    Found incumbent of value 0.521849 after 0.03 sec. (2.09 ticks)
    ...
    Root relaxation solution time = 0.03 sec. (3.19 ticks)
    ...
    *     0+    0                            0.5500        0.5955             8.27%
    ...
    Elapsed time = 0.32 sec. (99.57 ticks, tree = 0.02 MB, solutions = 3)
    ...
    Root node processing (before b&c):
      Real time             =    0.32 sec. (99.33 ticks)
    Parallel b&c, 2 threads:
      Real time             =    0.01 sec. (5.00 ticks)
      Sync time (average)   =    0.00 sec.
      Wait time (average)   =    0.00 sec.
                              ------------
    Total (root+branch&cut) =    0.33 sec. (104.33 ticks)
    
    Solution pool: 3 solutions saved.
    
    MIP - Integer optimal solution:  Objective =  5.5003296046e-01
    Solution time =    0.34 sec.  Iterations = 1088  Nodes = 17
    Deterministic time = 104.33 ticks  (309.69 ticks/sec)
    
    CPLEX> Incumbent solution written to file '/tmp/tmpb_02km0z.cplex.sol'.
...
.. parsed-literal::
    ...
    MIP search method: dynamic search.
    Parallel mode: deterministic, using up to 2 threads.
    Root relaxation solution time = 0.02 sec. (0.31 ticks)
    ...
    *     0+    0                            1.6754        1.8217             8.73%
    ...
    Solution time =    0.08 sec.  Iterations = 128  Nodes = 0
    Deterministic time = 9.20 ticks  (116.95 ticks/sec)
    
    CPLEX> Incumbent solution written to file '/tmp/tmpgqa6zbix.cplex.sol'.
    CPLEX> The solver exited normally.
    A feasible and provably optimal solution is available.
