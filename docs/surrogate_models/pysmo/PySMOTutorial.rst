...
The PySMO toolbox provides tools for generating different types of
reduced order models. PySMO currently provides tools for sampling and
...
in a text file called “brainin_30.txt”. We will use this data to train a
simple polynomial model. The data is in XY format, with the outputs
...
### Generating RBF models with PySMO
------------------------------------
...
### Training Kriging models with PySMO
--------------------------------------
...
.. parsed-literal::
    ...
    Final results
    ================
    Theta: [6.06053024 0.72623366] 
    Mean: [[241.09689498]] 
    Regularization parameter: 1.1521307092414055e-06
...
numerical_gradients is set to False). The user should try this.
...
.. parsed-literal::
    ...
    R2:  0.9999989680895109 
    RMSE:  0.05632052864934311
...
.. parsed-literal::
    ...
    -19317.791677411995*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.5518182560031254)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.2731190901874679)**2)) - 34735.83785607014*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.4300326512391472)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.8610629174234938)**2)) + 17789.347779213917*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.11035664436222248)**2)) + 4559.14575004112*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.6822668136056202)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.8414199967160326)**2)) + 47879.6092950264*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.13520535030959882)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.5811256814195772)**2)) + 30631.393480652594*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.908216841775921)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.20132180755786522)**2)) + 19599.50717079453*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.18501228557936236)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.09666279198240106)**2)) - 6484.508330097888*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.22021941796179972)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 1.0)**2)) - 66135.84512874298*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.8266365897830592)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.16264387978612238)**2)) - 28462.775115581462*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.831288905218487)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.26866011456766936)**2)) + 13911.295440454734*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.43739443999592303)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.9599385359524552)**2)) + 36.42237596772611*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.8327482651149929)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.3330572615505772)**2)) + 160765.80456794798*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.17485274298531528)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.3711736045917253)**2)) - 17692.05544097908*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.0009932894634358945)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.2461895993357224)**2)) + 10650.656535753631*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.8102253955808789)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546)**2)) + 508.9274426534539*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.6086081776493459)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.6109286075828757)**2)) - 43800.500205555465*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.1028770983224648)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.38063145554753214)**2)) - 2990.81271456345*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.0325313822086792)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.9084335925839453)**2)) - 3112.9067048230936*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 1.0)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.046386199083146756)**2)) - 5359.245204151433*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.9074219145138307)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.5830026053427076)**2)) - 3269.608527929522*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.7557460774371298)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.6383110566137417)**2)) + 986.5958766833646*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.5911925356865033)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.005381283583344741)**2)) - 129821.86432351917*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.21031274399063923)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.5495609776179707)**2)) + 70274.01791889546*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.7830308832306688)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.24439265066740792)**2)) + 26016.681889404543*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.28803140536417743)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.8689715765112118)**2)) + 1017.0813054590981*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.993941455353761)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.9026639746834018)**2)) + 29361.83684176067*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.36343808704287006)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.6057949629205177)**2)) + 14105.868994036922*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.3586109792561233)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.3372905989731323)**2)) - 94345.03362829983*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.17758838147122427)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.23089727866378493)**2)) + 7434.592192955315*exp(- (6.060530239436775*((x[1] + 4.929217157135412)/14.643030012320084 - 0.04112204875223326)**2 + 0.7262336567155705*((x[2] - 0.22882456869508516)/14.45053220191546 - 0.5088149538788017)**2)) + 241.09689498049997
