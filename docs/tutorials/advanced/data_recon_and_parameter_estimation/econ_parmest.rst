...
.. parsed-literal::
    ...
    2020-07-10 21:52:29 [INFO] idaes.init.fs.econ.side_1: Initialization Complete
    2020-07-10 21:52:29 [INFO] idaes.init.fs.econ.side_2: Initialization Complete
...
.. parsed-literal::
    ...
    {'Problem': [{'Lower bound': -inf, 'Upper bound': inf, 'Number of objectives': 1, 'Number of constraints': 118, 'Number of variables': 118, 'Sense': 'unknown'}], 'Solver': [{'Status': 'ok', 'Message': 'Ipopt 3.13.2\\x3a Optimal Solution Found', 'Termination condition': 'optimal', 'Id': 0, 'Error rc': 0, 'Time': 0.014516830444335938}], 'Solution': [OrderedDict([('number of solutions', 0), ('number of solutions displayed', 0)])]}
