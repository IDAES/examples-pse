...
.. parsed-literal::
    ...
    Logfile '/tmp/tmp0u7tj4p3.cplex.log' open.
    ...
    CPLEX> Problem '/tmp/tmpmosu32dv.pyomo.lp' read.
    Read time = 0.10 sec. (0.28 ticks)
    CPLEX> Problem name         : /tmp/tmpmosu32dv.pyomo.lp
