...
.. parsed-literal::
    ...
    Logfile '/tmp/tmpvzo5e7mx.cplex.log' open.
    ...
    CPLEX> Problem '/tmp/tmpcvyjzoy0.pyomo.lp' read.
    Read time = 0.04 sec. (0.28 ticks)
    CPLEX> Problem name         : /tmp/tmpcvyjzoy0.pyomo.lp
