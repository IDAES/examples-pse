...
.. parsed-literal::
    ...
    Logfile '/tmp/tmpkeri6g1y.cplex.log' open.
    ...
    CPLEX> Problem '/tmp/tmpb80eufts.pyomo.lp' read.
    Read time = 0.04 sec. (0.34 ticks)
    CPLEX> Problem name         : /tmp/tmpb80eufts.pyomo.lp
