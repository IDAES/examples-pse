...
.. parsed-literal::
    ...
    Logfile '/tmp/tmpn93bbhk0.cplex.log' open.
    ...
    CPLEX> Problem '/tmp/tmp8rtncoet.pyomo.lp' read.
    Read time = 0.26 sec. (3.48 ticks)
    CPLEX> Problem name         : /tmp/tmp8rtncoet.pyomo.lp
