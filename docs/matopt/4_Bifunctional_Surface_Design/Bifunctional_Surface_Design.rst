...
.. parsed-literal::
    ...
    Logfile '/tmp/tmp627410al.cplex.log' open.
    ...
    CPLEX> Problem '/tmp/tmpyfazvdp2.pyomo.lp' read.
    Read time = 0.31 sec. (3.48 ticks)
    CPLEX> Problem name         : /tmp/tmpyfazvdp2.pyomo.lp
